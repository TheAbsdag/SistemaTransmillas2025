  ...
  <div class="card shadow p-3 mb-4 bg-body rounded">
    <div class="card-header mi-header">
      <div class="d-flex align-items-center justify-content-between">
          ...
          <!-- Título centrado -->
          <h3 class="mb-0 mx-auto">Precios</h3>
      </div>
            ...
            <div class="col-md-4">
              <div class="form-check mt-4">
                <input 
                  ...
                  title="Marque si desea editar información del precio. Si no se marca, el precio se actualizará por completo."
                >
...
$(document).ready(function () {
  ...
  const tabla = $('#tablaUsuarios').DataTable({
    ...
    ajax: {
      url: '/nueva_plataforma/controller/PreciosController.php',
      type: 'POST',
      data: function (d) {
        d.ajax = true;
  ...
  $('#tablaUsuarios tbody').on('click', '.editar-registro', function () {
    ...
    $.ajax({
      ...
      success: function (res) {
        ...
        $('#edit_destino').val(data.pre_idciudaddes);
        $('#edit_pre_preciokilo').val(data.pre_kilo);
      ...
      success: function(res) {
        ...
        if (!Array.isArray(data) || data.length === 0) {
          ...
          data.forEach(r => {
            ...
            const matchPrecios =
              $("#add_pre_preciokilo").val() == r.pre_kilo &&
      ...
      success: function(res) {
        ...
        if (!Array.isArray(data) || data.length === 0) {
          ...
          data.forEach(r => {
            ...
            const matchPrecios =
              $("#edit_pre_preciokilo").val() == r.pre_kilo &&
...
$('#btnExcel').on('click', function () {
  ...
  window.location.href =
    '/nueva_plataforma/controller/PreciosController.php?' + params.toString();
});
</script>
</body>
</html>
