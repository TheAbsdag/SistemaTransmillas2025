  ...
  $va=0; 
	  while($rw1=mysqli_fetch_row($DB->Consulta_ID))
	  {
		...
		if($idusuario>=1 and $mostrar==true){
			...
			echo$tablaNomina = "SELECT `pri_confirma`, `idprimas`, `pri_docprima`, `pri_confirmaUsus`, `pri_fechaconfirmausu`, `pri_confiAdmin`, `pri_fechaadminconfi`, `pri_idadminconfi`, `pri_fecha_inicio`, `pri_fecha_fin`, `pri_idusu`, `pri_semestre`, `pri_img_compro` 
							FROM `primas` 
