					...
					echo "<td></td>";
							...
							if($imprimir==1){
								...
								if($rw2[5]=="descanso"){ $color="#82E0AA";
									...
									echo "<td colspan='1' width='0' align='center' ><a id='link'  onclick='pop_dis16($idingresouser,\"Trabaja con:\",\"$rw1[3]\")';  title='Zona' >$compañero</td>"; //COMPAÑERO TRABAJO
			...
			if ($motivoingresoo == false ) {
					...
					if($imprimir==1){
							...
							if ($motivoingresoo == false ) {
								...
								echo "<td colspan='1' width='0' align='center' ><a id='link'  onclick='pop_dis16($idingresouser,\"Trabaja con:\",\"$rw1[3]\")';  title='Zona' >$compañero</td>"; //ZONA TRABAJO
