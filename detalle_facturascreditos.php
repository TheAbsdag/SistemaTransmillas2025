...
$guias=0;
	...
	$html.= "<td colspan='1' width='0' align='center' ><a id='link'  onclick='pop_dis16($id_p,\"Editar Factura Externa\",\"$rw1[3]\")';  title='pagoconfirmado' >Editar</td>";
	...
	$FB->titulo_azul1("Editar externos",1,0,0); 
